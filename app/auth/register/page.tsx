...
import { register, selectAuthError, selectAuthLoading, selectIsAuthenticated } from '@/store/slice/authSlice';
            ...
            <div className="p-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500">
              <div className="bg-white dark:bg-slate-800 rounded-xl p-8">
                <motion.div variants={itemVariants} className="text-center mb-8">
                  ...
                  <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Join SaaSPro</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <motion.div variants={itemVariants} className="flex items-center text-sm">
                    <input
                      id="terms"
                      name="terms"
                      type="checkbox"
                    ...
                    />
                    <label htmlFor="terms" className="ml-2 block text-gray-700 dark:text-gray-300">
                      I agree to the{' '}
