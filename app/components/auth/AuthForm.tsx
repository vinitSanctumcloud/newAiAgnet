            ...
            <div className="w-full md:w-1/2 p-8 md:p-12">
              ...
              <CardContent className="px-0 pb-0">
                ...
                <motion.div 
                  ...
                  animate="visible"
                >
                  {/* Social Login Buttons - Only show on login page */}
                  {isLoginPage && (
                    <>
                      <motion.div
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    {/* Name Field - Only show on register page */}
                    {isRegisterPage && (
                    ...
                    {/* Phone Field - Only show on register page */}
                    {isRegisterPage && (
                      <motion.div variants={itemVariants} className="space-y-2">
                    ...
                    {/* Remember Me Checkbox - Only show on login page */}
                    {isLoginPage && (
                      <motion.div
                    ...
                    {/* Terms Agreement - Only show on register page */}
                    {isRegisterPage && (
                      <motion.div
                  ...
                  {/* Navigation Links */}
                  <motion.div 
                    className="text-center text-sm text-gray-600 pt-6"
                    variants={itemVariants}
                  >
                    {isLoginPage ? (
                      <p>
